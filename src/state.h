...
typedef enum nqiv_event_priority
{
	...
	NQIV_EVENT_PRIORITY_IMAGE_LOAD = 3,
	NQIV_EVENT_PRIORITY_THUMBNAIL_LOAD_EPHEMERAL = 4,
	NQIV_EVENT_PRIORITY_THUMBNAIL_LOAD = 5,
	NQIV_EVENT_PRIORITY_THUMBNAIL_SAVE_LOAD_FAIL = 6,
	NQIV_EVENT_PRIORITY_THUMBNAIL_SAVE_LOAD_NO = 7,
} nqiv_event_priority;
