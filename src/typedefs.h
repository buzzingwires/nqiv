 ...
 * files, as well as some other circularly-shared things. This file should not include any other nqiv file and should be included before the circularly referenced elements are needed. */

typedef struct nqiv_cmd_manager nqiv_cmd_manager;
typedef struct nqiv_state       nqiv_state;

/* Standard return value for functions that need to report a more precise status than true or false. These values should be 'truthy' though, evaluating as booleans would. */
