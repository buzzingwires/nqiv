...
nqiv (**n**eo **q**uick **i**mage **v**iewer) intends to build on the lineage of [qiv](https://spiegl.de/qiv/) with modern features such as multithreading and GPU rendering while maintaining portability, and an emphasis on usability.
