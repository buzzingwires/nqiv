...
void array_test_standard(nqiv_array* array, const int start_length, const int end_length, const int max_length, const int push_count, const bool unlimit)
{
...
void array_test_default(void)
{
	...
	array_test_standard(array, sizeof(int) * 1, sizeof(int) * (5 * 2 + 1), array->max_data_length, 6, true);
...
void array_test_inherit(void)
{
	...
	array_test_standard(&array, ARRAY_TEST_STANDARD_SIZE * sizeof(int), ARRAY_TEST_STANDARD_SIZE * sizeof(int), ARRAY_TEST_STANDARD_SIZE * sizeof(int), ARRAY_TEST_STANDARD_SIZE, false);
}
